...
if (nam % 4 == 0 and nam % 100 != 0) or (nam % 400 == 0):
    ...
    print(nam,"không phải là năm nhuận")
        ...
        #input: 2023
        #output: không phảiphải năm nhuận
...
print(khoang_cach)
        ...
        #input :x=1,y=2,a=4,b=3,r=5
        #output : true, khoảng canh= 3.16
...
if a + b > c and b + c > a and a + c > b :
    ...
    print(" không phải là tam giác")
        ...
        #input: a=1,b=2,c=3
        #output: khoong phải là tam giác
...
print("số lớn nhất trong ba số là : ", so_lon_nhat)
        ...
        #input: x=2,y=6,z=5
        #output: số lớn nhất trong ba số là : 6
...
print("Lương ròng:", luong_rong, "triệu VND")
        ...
        #input : 24
        #output: thuế thu nhập=7.1919 triệu , lương ròng=16.88 triệu
